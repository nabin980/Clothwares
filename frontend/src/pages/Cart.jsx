      ...
      <div className="">
        {cartData.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className="py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:frid-cols-[4fr_2fr_0.5fr items-center gap-4"
            >
              <div className="flex items-start gap-6">
                ...
                />
                <div>
                  <p className="text-xs font-medium sm:text-xl">{productData.name}</p>
